    ...
    public void onBindViewHolder(@NonNull final HomeHolder holder, @SuppressLint("RecyclerView") final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                bundle = new Bundle();
                bundle.putString(Function.SOURCE, articlesItemList.get(position).getSource().getName());
                bundle.putString(Function.AUTHOR, articlesItemList.get(position).getAuthor());
                bundle.putString(Function.TITLE, articlesItemList.get(position).getTitle());
                bundle.putString(Function.DESC, articlesItemList.get(position).getDescription());
                bundle.putString(Function.URL, articlesItemList.get(position).getUrl());
                bundle.putString(Function.IMAGE, articlesItemList.get(position).getUrlToImage());
                bundle.putString(Function.DATE, articlesItemList.get(position).getPublishedAt());
                bundle.putString(Function.CONTENT, articlesItemList.get(position).getContent());
